...
public class Resuelta12_11 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Set<Socio12_11> socios = new TreeSet<>();
		try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("socios.dat"))) {
			socios = (TreeSet<Socio12_11>) in.readObject();
		...
		do {
			...
			case 2 -> {
				...
				String dni = new Scanner(System.in).next();
				socios.remove(new Socio12_11(dni));
			}
			case 3 -> {
				System.out.println("Dni: ");
				String dni = new Scanner(System.in).next();
			...
			case 5 -> {
				Comparator<Socio12_11> c = new Comparator<>() {

					@Override
					public int compare(Socio12_11 o1, Socio12_11 o2) {
						// TODO Auto-generated method stub
						return o2.antiguedad() - o1.antiguedad();
					}
				};
				Set <Socio12_11> s=new TreeSet<>(c);
				s.addAll(socios);
	...
	static boolean alta(Set<Socio12_11> socios, String dni) {
		System.out.println("Nombre: ");
		String nombre = new Scanner(System.in).next();
		System.out.println("Fecha alta: ");
		String fechAlta = new Scanner(System.in).next();
		Socio12_11 nuevo = new Socio12_11(dni, nombre, fechAlta);
